...
def get_supported_labels() -> Tuple[str, str, str, str, str, str, str, str, str, str, str, str, str]:
    ...
    return (
        ...
        'LIN',
        'PAR',
        'ACQ',  # these are copied to the corresponding MDH fields on Siemens
        # data flags
        'NAV',
        'REV',
        'SMS',  # these are copied to the corresponding MDH fields on Siemens
        'REF',
        'IMA',  # flags for parallel imaging
