...
## Table of contents 🧾
- [PyPulseq: A Python Package for MRI Pulse Sequence Design](#pypulseq-a-python-package-for-mri-pulse-sequence-design)
  - [Table of contents 🧾](#table-of-contents-)
  - [📢 Pulse sequence development in your browser!](#-pulse-sequence-development-in-your-browser)
  - [1. 👥 Contributors (alphabetical)](#1--contributors-alphabetical)
  - [2. 📚 Citations (reverse chronological)](#2--citations-reverse-chronological)
  - [Paulo (2018).](#paulo-2018)
  - [3. 🔨 Installation](#3--installation)
  - [4. ⚡ Lightning-start - PyPulseq in your browser!](#4--lightning-start---pypulseq-in-your-browser)
  - [5. 🏃‍♂ Quickstart - example scripts](#5--quickstart---example-scripts)
  - [6. 🤿 Deep dive - custom pulse sequences](#6--deep-dive---custom-pulse-sequences)
  - [7. 👥 Contributing and Community guidelines](#7--contributing-and-community-guidelines)
